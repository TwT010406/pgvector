...
bool        ivfflat_batch_enable_sort = true;
...
IvfflatInit(void)
{
	...
	DefineCustomBoolVariable("ivfflat.batch_enable_sort", "Enables TID sorting for batch search",
							 "When on, batch search requests are sorted by TID to optimize I/O.",
							 &ivfflat_batch_enable_sort,
							 true,
							 PGC_USERSET,
							 0,
							 NULL,
